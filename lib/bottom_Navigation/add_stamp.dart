...
class Addstamp extends StatefulWidget {
  ...
  @override
  _AddstampState createState() => _AddstampState();
}

class _AddstampState extends State<Addstamp> {
  ...
  hash(var id, filename) async {
    ...
    setState(() {
      var a = hash1;
      //01-02-2022 watermark functionality hide
                ...
                child: MouseRegion(
                  onEnter: (event) {
                    setState(() {
                      ...
                      //         : name.add(index)
                      //     : 01-02-2022 watermark functionality hide
                      index == 0 || index == 1 ? print("") : name.add(index);
                      a = true;
                    });
                  }, //_incrementEnter,
                  onExit: (event) {
                    setState(() {
                      ...
                      //         : name.remove(index)
                      //     :01-02-2022 watermark functionality hide
                      index == 0 || index == 1 ? print("") : name.remove(index);
                      a = false;
                    });
                  }, //_incrementEnterr,
                  child: IconButton(
